...
def digital_conetnt():
    ...
    if ('Whatsapp' not in source_list):
        print("in if");
        df_pivot = df_pivot[['Date','Source','Unique_Device_Clicked_On_Menu_5.1','Unique_Device_Clicked_On_Menu_5.2','Unique_Device_Clicked_On_Menu_5.3','Unique_Device_Clicked_On_Menu_5.4','Unique_Device_Clicked_On_Menu_5.5']]
...
df_merge.fillna(0, inplace=True);
df_merge_slice =df_merge[['Date', 'Source',"Unique_Devices","Unique_Users_Clicked_On_Tara", 'Unique_Device_Clicked_On_Menu_Option_Five','Unique_Device_Clicked_On_Menu_5.1','Unique_Device_Clicked_On_Menu_5.2','Unique_Device_Clicked_On_Menu_5.3','Unique_Device_Clicked_On_Menu_5.4','Unique_Device_Clicked_On_Menu_5.5']]
