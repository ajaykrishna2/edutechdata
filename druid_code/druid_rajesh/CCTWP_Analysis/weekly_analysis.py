...
os.environ['TZ'] = 'UTC';
todays_date      = date.today()+timedelta(-2)
seven_day_back   = todays_date +timedelta(-7);
...
def National_Metric():
        ...
        try:
            ...
            upload_gsheet("National_Chandigarh_CCTWP_Analysis_Final","National_Weekly_Analysis",header_list,overall_snapshot)
...
def Chandigarh_Metric():
    ...
    try:
        ...
        header_list = list(df_slice.columns);
        overall_snapshot = df_slice.values.tolist();
        upload_gsheet("National_Chandigarh_CCTWP_Analysis_Final", "Chandigarh_Weekly_Analysis", header_list, overall_snapshot)
